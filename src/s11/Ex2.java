  ...
  static class GSTMap<K extends Comparable<K>, V> {
    ...
    class GSTNode <K1 extends Comparable<K1>, V1> {
      ...
      private void split() {
        ...
        int mid=n/2;
        GSTNode<K1,V1> a=new GSTNode<K1,V1>(this, 0, mid);
        GSTNode<K1,V1> b=new GSTNode<K1,V1>(this, mid, n);
