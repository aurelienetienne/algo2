...
public class SplayTreePerfTest {
  ...
  public static void perf() {
    int n=20000;
    perfExperiment(new StdTreeSet<Integer>(), n);
    perfExperiment(new StdTreeSet<Integer>(), 2*n);
    System.out.println();
    perfExperiment(new StdHashSet<Integer>(), n);
    perfExperiment(new StdHashSet<Integer>(), 2*n);
    System.out.println();
    perfExperiment(new MySplayTree<Integer>(), n);
    perfExperiment(new MySplayTree<Integer>(), 2*n);
  }
