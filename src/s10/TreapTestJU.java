...
public class TreapTestJU {
  ...
  public static void testSet(int n) {
    ...
    assertTrue(areSetEqual(s, bs));
    System.out.println("Nombre d'ajout: " + s.addition);
    System.out.println("Nombre de retrait: " + s.withdrawal);
    System.out.println("Nombre de rotation pour les ajouts: " + s.rotationAddition);
    System.out.println("Nombre de rotation pour les retraits: " + s.rotationWithdrawal);
    System.out.println("Nombre de rotation/ajout: " + (s.rotationAddition/s.addition)); 
    System.out.println("Nombre de rotation/retrait: " + (s.rotationWithdrawal/s.withdrawal));
